...
export async function PUT(request: NextRequest) {
  try {
    ...
    const timezone = (typeof body.timezone === 'string' && body.timezone.trim()) ? body.timezone : 'EST'
    const companySize = (typeof body.company_size === 'string' && body.company_size.trim()) ? body.company_size : 'startup'
    const maxMeetingsPerWeek = (typeof body.max_meetings_per_week === 'string' && body.max_meetings_per_week.trim()) ? body.max_meetings_per_week : '1'
